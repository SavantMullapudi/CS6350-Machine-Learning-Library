...
train_data = pd.read_csv('ML HW 3/bank-note/train.csv', header=None, names=column_names)
test_data = pd.read_csv('ML HW 3/bank-note/test.csv', header=None, names=column_names)
